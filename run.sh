...
then
    ...
    JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-11.0.7.jdk/Contents/Home/ java -jar target/pangolin_experimental-0.0.1-SNAPSHOT-jar-with-dependencies.jar $@
